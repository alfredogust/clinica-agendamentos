...
class AppointmentIntegrationTest {
        ...
        void shouldRegisterAppointmentWhenValid() {
                ...
                CreateProfessionalRequest professionalRequest = new CreateProfessionalRequest("Maria Silva",
                                "maria@gmail.com",
        ...
        void shouldCancelAppointmentWhenValid() {
                ...
                CreateProfessionalRequest professionalRequest = new CreateProfessionalRequest("Jorge Cunha",
                                "jorgec@gmail.com", "plainPassword", Specialty.ORTHOPEDICS);

                ProfessionalResponse professional = professionalService.register(professionalRequest);

                CreateUserRequest userRequest = new CreateUserRequest("Ana Gabri", "gabriann@gmail.com",
                                "plainPassword");

                UserResponse patient = userService.register(userRequest);

                CreateAppointmentRequest appointmentRequest = new CreateAppointmentRequest(professional.id(),
                                patient.id(), OffsetDateTime.parse("2026-08-15T10:00:00Z"));

                AppointmentResponse response = appointmentService.register(appointmentRequest);

                AppointmentResponse cancelled = appointmentService.cancel(response.id());
